...
curl 'https://api2.arduino.cc/iot/v1/devices' -X PUT \
-H 'Accept-Encoding: gzip, deflate, br'  \
-H 'Authorization: Bearer eMahtGdZuLCOC74syNTWtwQ2WreYsoxeRI-ylHug280.AxcZ-Lx2DXa4fcq3DpXVCmbrwC3o_ubZZ-5ttj_Z-0M' \
-H 'Content-Type: application/json;charset=UTF-8' \
-H 'Accept: application/json, text/plain, */*' \
--data-binary '{"name":"cURL-device","type":"generic"}' --compressed | jq
...
curl 'https://api2.arduino.cc/iot/v1/devices/connect' -X POST  \
-H 'Accept-Encoding: gzip, deflate, br'  \
-H 'Authorization: Bearer eMahtGdZuLCOC74syNTWtwQ2WreYsoxeRI-ylHug280.AxcZ-Lx2DXa4fcq3DpXVCmbrwC3o_ubZZ-5ttj_Z-0M' \
-H 'Accept: application/json, text/plain, */*' \
-H 'Content-Length: 0' --compressed | jq
# returns 
# {
...
curl 'https://api2.arduino.cc/iot/v1/devices/containtel:703a0310-6166-4ed9-b8a0-27ca976e3b23' -X POST  \
-H 'Accept-Encoding: gzip, deflate, br'  \
-H 'Authorization: Bearer eMahtGdZuLCOC74syNTWtwQ2WreYsoxeRI-ylHug280.AxcZ-Lx2DXa4fcq3DpXVCmbrwC3o_ubZZ-5ttj_Z-0M' \
-H 'Accept: application/json, text/plain, */*' \
